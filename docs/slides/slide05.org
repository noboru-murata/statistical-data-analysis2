...
# Time-stamp: <2025-10-31 16:34:42 mura>
:REVEAL:
...
- 観測値とあてはめ値の比較
  #+begin_src R :file figs/05_models.png :exports results :results graphics
    ...
    tw_subset |>
      ...
      theme(legend.position.inside = c(.88,.15))
  #+end_src
...
- 関連データの散布図
  #+begin_src R :file figs/05_interaction.png :exports results :results graphics
    #' 関連データの散布図
    tw_subset |>
      select(temp,solar,press) |>
      GGally::ggpairs(columnLabels=c("気温","日射","気圧"))
  #+end_src
...
- 関連データの散布図
  #+begin_src R :file figs/05_categorical.png :exports results :results graphics
    ...
    tw_data_cat |>
      select(temp,rain,month) |>
      GGally::ggpairs(aes(colour = rain),
                      columnLabels=c("気温","降雨","月"))
  #+end_src
