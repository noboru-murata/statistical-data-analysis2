...
# Time-stamp: <2025-11-17 13:52:29 mura>
:REVEAL:
...
- Nutritional and Marketing Information on US Cereals
  - Rの ~package::MASS~ に含まれるデータセット
    #+begin_quote
    The UScereal data frame has 65 rows and 11 columns. The data come
    from the 1993 ASA Statistical Graphics Exposition, and are taken
    from the mandatory F&DA food label. The data have been normalized
    here to a portion of one American cup.
    #+end_quote

#+reveal: split
#+begin_src R :eval no :exports none
  uc_data |> View() # 左上ペインに表として表示
#+end_src
...
#+begin_src R :exports none
  ...
  uc_pca <-
    uc_data |>
    select(where(is.double),-calories,-fat,-sugars) |> # double型から選択
    prcomp(scale. = TRUE)
#+end_src

#+reveal: split
#+begin_src R :file figs/uc-pairs.png :exports results :results graphics :height 700
  uc_data |>
    ggpairs(columns = which(sapply(uc_data,is.double)),
...
#+RESULTS[059fc0df384bd757a3fe729a96c8c42ac66334ba]:

#+caption: 散布図行列
#+name: fig:uc-pairs
#+attr_html: height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/uc-pairs.png]]


#+reveal: split
#+begin_src R :file figs/uc-biplot.png :exports results :results graphics :height 700
  #' 主成分得点の表示
  autoplot(uc_pca,
           data = uc_data,
           size = "calories", 
...
#+RESULTS[0d8db5d69fbb3711382277153a6a0123709678ff]:

#+caption: 主成分得点の散布図
#+name: fig:uc-biplot
#+attr_html: height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/uc-biplot.png]]

#+reveal: split
#+begin_src R :file figs/uc-biplot-zoom.png :exports results :results graphics :height 700
  #' 主成分得点 (中心部拡大)
  autoplot(uc_pca,
           data = uc_data,
           colour = "mfr",
...
#+end_src
#+caption: 主成分得点の散布図(中心部の拡大)
#+name: fig:uc-biplot-zoom
#+attr_html: height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/uc-biplot-zoom.png]]

* COMMENT 主成分分析の例
** 県毎の生活環境の違いの分析
#+caption: 県別の生活環境に関するデータ
#+name: tbl:ja_data
#+begin_src R :exports none
  #' 主成分分析の例
  #' 表の作成
...
#+begin_src R :exports results :results output html :tangle no
  #' データの表示(reveal用)
  ja_data |>
    select(c(1,4,5,9,10,12,18,19,20,21,23)) |> # 大きな表なので一部の列を選択する
    slice(1:15) |>
    gt() |>
    as_raw_html()
#+end_src
...
#+reveal: split
#+begin_src R :file figs/ja-pairs1.png :exports results :results graphics :height 700
  ja_data |>
...
#+caption: 県別の生活環境(教育・労働などに関連する項目)
#+name: fig:ja-pairs1
#+attr_html: height 100%
#+attr_latex: :width 0.6\linewidth
...
#+reveal: split
#+begin_src R :file figs/ja-pairs2.png :exports results :results graphics :height 700
  ja_data |>
...
#+reveal: split
#+begin_src R :file figs/ja-pairs3.png :exports results :results graphics :height 700
  ja_data |>
...
#+reveal: split
#+begin_src R :file figs/ja-biplot.png :exports results :results graphics :height 700
  ja_fit <- ja_data |> 
...
:END:
:LOGBOOK:
CLOCK: [2025-11-05 Wed 00:03]--[2025-11-05 Wed 00:03] =>  0:00
:END:
- データ(の一部)の内容
  #+begin_src R :exports none
    #' データの読み込み
...
#+reveal: split
- データの箱ひげ図
  #+begin_src R :file figs/js_boxplot.png :exports results :results graphics
    js_data |> # 箱ひげ図．変数のばらつきに大きな違いがある
...
#+reveal: split
- 標準化したデータの箱ひげ図
  #+begin_src R :file figs/js_scaled_boxplot.png :exports results :results graphics
...
#+caption: 箱ひげ図 (データを標準化)
#+name: fig:js_scaled_boxplot
#+attr_html: height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/js_scaled_boxplot.png]]
