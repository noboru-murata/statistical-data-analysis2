...
# Time-stamp: <2025-12-30 22:17:29 mura>
:REVEAL:
...
#+begin_src R :file figs/ts_ma.png :exports results :results graphics :tangle no
  ...
  ts_ma |>
    as_tsibble() |>
    autoplot(value, show.legend = FALSE) +
    labs(title = expression(X[t] == 0.44*epsilon[t-1] - 0.28*epsilon[t-2] + epsilon[t]),
         x = "Time", y = "Observation")
#+end_src
...
#+reveal: split
#+begin_src R :file figs/ts_arpacf.png :exports results :results graphics :tangle no
  #' AR(2)モデルの偏自己相関
  ts_ar |> as_tsibble() |> PACF(value) |>
      autoplot() + 
      facet_wrap(key ~ .) + 
      labs(title = "AR(2)")
#+end_src
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/ts_arpacf.png]]

#+reveal: split
#+begin_src R :file figs/ts_mapacf.png :exports results :results graphics :tangle no
  #' MA(2)モデルの偏自己相関
  ts_ma |> as_tsibble() |> PACF(value) |>
      autoplot() + 
      facet_wrap(key ~ .) +
      labs(title = "MA(2)")
#+end_src
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/ts_mapacf.png]]

#+reveal: split
#+begin_src R :file figs/ts_armapacf.png :exports results :results graphics :tangle no
  #' ARMA(2,1)モデルの偏自己相関
  ts_arma |> as_tsibble() |> PACF(value) |>
      autoplot() + 
      facet_wrap(key ~ .) +
      labs(title = "ARMA(2,1)")
#+end_src
#+name: fig:ts_armapacf
#+caption: ARMA過程の偏自己相関
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/ts_armapacf.png]]
...
#+reveal: split
#+begin_src R :file figs/ap_ets.png :exports results :results graphics :tangle no
  ap_fit |> select(ets) |>
    forecast(h = nrow(ap_test)) |>
    autoplot(ap_train) +
    autolayer(ap_test, value, colour = "purple") +
...
#+end_src
#+name: fig:ap_ets
#+caption: ETSモデル(exponential smoothing)による予測
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/ap_ets.png]]

** COMMENT 数値例
#+name: fig:ts_pred_wn
#+begin_src R :file figs/ts_pred_wn.png :exports results :results graphics :tangle no
  ## library(forecast)
  ## library(tidyverse)
  ## library(ggfortify)
  ## ## ARMA過程を生成する関数
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/ts_pred_wn.png]]

#+reveal: split

#+name: fig:ts_pred_rw
#+begin_src R :file figs/ts_pred_rw.png :exports results :results graphics
  ## ランダムウォークの予測
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/ts_pred_rw.png]]

#+reveal: split
#+name: fig:ts_pred_arma
#+begin_src R :file figs/ts_pred_arma.png :exports results :results graphics
  ## ARMA 過程の予測
...
:END:
#+name: fig:covid_patients
#+begin_src R :file figs/covid_patients.png :exports results :results graphics
  ### 基本的な時系列モデルによる予測
...
:END:
#+name: fig:covid_patients
#+begin_src R :file figs/covid_patients.png :exports results :results graphics :tangle no
  ### 基本的な時系列モデルによる予測
  ### 厚生労働省のCOVID-19の感染者数データを用いた例
...
:END:
#+name: fig:covid_3wave_patients
#+begin_src R :file figs/covid_3wave_patients.png :exports results :results graphics :tangle no
  #'
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_3wave_patients.png]]

** 基礎分析 (分析対象 : 2020/9/15-11/30)
:PROPERTIES:
:ID:       475BB63E-C3DE-4893-94BB-32B4BC65B1CF
:END:
#+name: fig:covid_3wave
#+begin_src R :file figs/covid_3wave.png :exports results :results graphics :tangle no
  #' 階差系列の描画
  cp_3rd_train |>
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_3wave.png]]

#+reveal: split
#+name: fig:covid_3wave_log
#+begin_src R :file figs/covid_3wave_log.png :exports results :results graphics :tangle no
  #' 対数変換+階差系列の描画
  cp_3rd_train |>
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_3wave_log.png]]

#+reveal: split
#+name: fig:covid_3wave_log7
#+begin_src R :file figs/covid_3wave_log7.png :exports results :results graphics :tangle no
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_3wave_log7.png]]
...
#+reveal: split
#+begin_src R :file figs/covid_3wave_arima_est.png :exports results :results graphics :tangle no
  #' データとあてはめ値を表示
  cp_3rd_arima |>
      augment() |>
      autoplot(patients, colour = "skyblue") +
...
#+end_src
#+name: fig:covid_3wave_arima_est
#+caption: あてはめ値
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_3wave_arima_est.png]]

#+reveal: split
#+begin_src R :file figs/covid_3wave_arima_diag.png :exports results :results graphics :tangle no
  #' 残差の診断
  cp_3rd_arima |> gg_tsresiduals()
  #' 残差の相関はだいぶ消えているので，そこそこ良いモデルといえそう
#+end_src
#+name: fig:covid_3wave_arima_diag
#+caption: 診断プロット
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_3wave_arima_diag.png]]

#+reveal: split
#+name: fig:covid_3wave_arima_pred
#+begin_src R :file figs/covid_3wave_arima_pred.png :exports results :results graphics :tangle no
  #' 後半を予測してみる
  cp_3rd_arima |> 
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_3wave_arima_pred.png]]

** COMMENT 分解モデルによる推定
- 局所線形構造モデルによる分解
#+name: fig:covid_3wave_sts_decomp
#+begin_src R :file figs/covid_3wave_sts_decomp.png :exports results :results graphics
  ## StructTS による方法
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_3wave_sts_decomp.png]]

#+reveal: split

#+name: fig:covid_3wave_sts_est
#+begin_src R :file figs/covid_3wave_sts_est.png :exports results :results graphics
  ## モデルによる当て嵌めの視覚化
  p <- 
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_3wave_sts_est.png]]

#+reveal: split

#+name: fig:covid_3wave_sts_diag
#+begin_src R :file figs/covid_3wave_sts_diag.png :exports results :results graphics
  ## 診断プロット
  tsdiag(est.sts)
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_3wave_sts_diag.png]]

#+reveal: split

#+name: fig:covid_3wave_sts_pred
#+begin_src R :file figs/covid_3wave_sts_pred.png :exports results :results graphics
  ## 12月以降(最大60日)を予測してみる
  p <- 
    ggplot(data = fortify(forecast(est.sts,
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_3wave_sts_pred.png]]

** COMMENT 第8波における感染者数の推移
:PROPERTIES:
:ID:       CF34CC7C-19C1-4250-85F1-A84C3BFA5894
:END:
#+name: fig:covid_8wave_patients
#+begin_src R :file figs/covid_8wave_patients.png :exports results :results graphics
  ## 第8波 (2022/10/10-現在)
  p <-
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_8wave_patients.png]]
...
#+name: fig:covid_8wave_arima_diag
#+begin_src R :file figs/covid_8wave_arima_diag.png :exports results :results graphics
  ## 診断プロット
  tsdiag(est.arima)
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_8wave_arima_diag.png]]

#+reveal: split

#+name: fig:covid_8wave_arima_est
#+begin_src R :file figs/covid_8wave_arima_est.png :exports results :results graphics
  ## モデルによる当て嵌めの視覚化
  p <- 
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_8wave_arima_est.png]]

#+reveal: split

#+name: fig:covid_8wave_arima_pred
#+begin_src R :file figs/covid_8wave_arima_pred.png :exports results :results graphics
  ## 12月以降(最大60日)を予測してみる
  p <- 
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_8wave_arima_pred.png]]
...
#+name: fig:covid_8wave_sts_diag
#+begin_src R :file figs/covid_8wave_sts_diag.png :exports results :results graphics
  ## 診断プロット
  tsdiag(est.sts)
  ## こちらも残差に相関が残っているので，優れたモデルという訳ではない
#+end_src
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_8wave_sts_diag.png]]

#+reveal: split

#+name: fig:covid_8wave_sts_decomp
#+begin_src R :file figs/covid_8wave_sts_decomp.png :exports results :results graphics
  ## StructTSによる時系列の分解結果
  autoplot(est.sts)
#+end_src
#+caption: 時系列の分解結果
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_8wave_sts_decomp.png]]

#+reveal: split

#+name: fig:covid_8wave_sts_est
#+begin_src R :file figs/covid_8wave_sts_est.png :exports results :results graphics
  ## モデルによる当て嵌めの視覚化
  p <- 
      ggplot(data = fortify(forecast(est.sts)) %>%
                 dplyr::mutate(Index=as.Date(Index)),
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_8wave_sts_est.png]]

#+reveal: split

#+name: fig:covid_8wave_sts_pred
#+begin_src R :file figs/covid_8wave_sts_pred.png :exports results :results graphics
  ## 12月以降(最大60日)を予測してみる
  p <- 
    ggplot(data = fortify(forecast(est.sts,
                                   h=min(length(test),60))) %>%
...
#+attr_html: :height 100%
#+attr_latex: :width 0.6\linewidth
[[file:figs/covid_8wave_sts_pred.png]]
