...
人工データによる $t$ 統計量の性質を調べるために，以下のような重回帰モデル(適宜変更して構わない)での試行を設定する．
...
press単体では係数の推定精度も決定係数も低いが，solarと組み合わせることにより精度が上がり説明力も高くなる． また，組み合わせた方が自由度調整済決定係数はsolar単体より大きくなる．
